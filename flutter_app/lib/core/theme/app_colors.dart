...
class AppColors {
  ...
  static const Color primary = Color(0xFFFF5B37); // Warm Coral Orange (mymind signature)
  ...
  // Backgrounds & Canvas
  static const Color background = Color(0xFFF7F8FA); // Ultra-clean subtle warm white
